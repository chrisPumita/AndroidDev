        ...
        imgBtnPhone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (phoneNumber != null && !phoneNumber.isEmpty()) {
                    ...
                    Toast.makeText(ThirdActivity.this, "Agregar número de teléfono", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        imgBtnWeb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (url != null && !url.isEmpty()) {
                    ...
                    intentMail.putExtra(Intent.EXTRA_SUBJECT, "PROTECO APP");
                    intentMail.putExtra(Intent.EXTRA_TEXT, "Hola! Estoy tomando la última clase de Android Básico #CursosIntersemestrales");
                    intentMail.putExtra(Intent.EXTRA_EMAIL, new String[] {"adrian@stumy.mx", "adrian.proteco@gmail.com"});
        ...
        switch (requestCode) {
            case PICTURE_FROM_CAMERA:
                ...
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    Toast.makeText(this, "Ups... Hubo un error en la foto, prueba otra vez.", Toast.LENGTH_LONG).show();
                }
                break;
            default:
