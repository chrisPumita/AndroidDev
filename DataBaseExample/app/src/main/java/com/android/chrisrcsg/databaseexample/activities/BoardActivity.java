package com.android.chrisrcsg.databaseexample.activities;
...
import com.android.chrisrcsg.databaseexample.adapters.BoardAdapter;
...
public class BoardActivity extends AppCompatActivity implements RealmChangeListener<RealmResults<Board>>, AdapterView.OnItemClickListener{
    ...
    private com.android.chrisrcsg.databaseexample.adapters.BoardAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Db Realm evantando la BD
        realm = Realm.getDefaultInstance();
        boards = realm.where(Board.class).findAll(); //SELECT * FROM
        boards.addChangeListener(this); //Listener para CRUD Cambio en la lista de Board
